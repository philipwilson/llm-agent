...
Ollama models use `ollama:` prefix: `ollama:qwen3.5:122b`, `ollama:mistral`, etc. Aliases: `qwen3` → `ollama:qwen3.5:122b`, `qwen3-cloud` → `ollama:qwen3.5:cloud`, `nemotron-nano` → `ollama:nemotron-3-nano:latest`.
